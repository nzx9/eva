...
def getFeatureMaps(image, k, mapp):
	...
	## k we limit the accuracy of the edge detection but it saves time.
	...
	func2(mappmap, r, alfa, nearest, w, k, height, width, sizeX, sizeY, p, stringSize)
	mapp['map'] = mappmap
	### ~0.001s
